![Badge-glow](https://img.shields.io/badge/GlowCookies-v.1.7-blue)
...
```html
<script src="https://cdn.jsdelivr.net/gh/manucaralmo/GlowCookies@1.7/v1/cookiesGlow.js" async></script>
<script>
